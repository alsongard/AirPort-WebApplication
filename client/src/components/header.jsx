...
function Header(props){
    ...
    return (
        <header className="flex flex-row items-center justify-between px-6 py-4 bg-white dark:bg-gradient-to-r from-slate-800 to-[rgba(69,85,108,0.4)]  shadow">
            <div className="text-2xl font-bold text-blue-600">
                {/* Logo */}
                SkyLux Travel
            </div>
            <nav className='flex space-x-[20px] items-center'>
