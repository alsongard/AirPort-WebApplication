...
const UserDetailRouter = require("./routes/userdetails.router");
...
app.use("/api/users", UserRouter); // success
app.use("/api/flights", FlightRouter); //success
app.use("/api/booking", BookingRouter); // success
